      ...
      <div className="relative z-10 px-4 py-20 max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Video Preview */}
            <div className="relative group animate-fade-in-up rounded-2xl overflow-hidden border border-accent/20 hover:border-accent/40 transition-all duration-300" style={{ animationDelay: "0.2s" }}>
